  ...
  return (
    <article className="bg-white px-40 pb-20 text-xl">
      ...
      <p className="mb-4 text-justify">
        ...
        information that you have provided to us is dealt with properly and
        securely and so that you know how to seek a remedy if you are not
        satisfied with our use of your information. Tech Techies is a Data
        Controller and is a joint data controller in respect of the information
        that you have provided to us in order to enable us to process your
        donation. This means that Tech Techies is responsible for the proper use
      ...
      <p className="mb-4 text-justify">
        ...
        specified purposes (such as keeping up to date with Tech Techies&apos;
        work). Since you have elected to receive further information from Tech
        Techies, such as our newsletter, then we have to retain contact
        information, including your identity and contact details, for as long as
        you wish to continue to receive information from us. We will contact you
      ...
      <p className="mb-4 text-justify">
        ...
        manner that is compliant with the regulation (see Automated Decision
        Making).
      </p>
      ...
      <ul className="list-disc">
        ...
        <li>
          The right to request Tech Techies to correct any errors in the
          personal information that we hold about you. We may request some
          evidence to confirm that an error has been made.
        </li>
        <li>
          The right to ask Tech Techies to erase any personal data that Tech
          Techies holds on you (although that right does not apply where Tech
          Techies has a legal obligation to retain it).
        </li>
      </ul>
    </article>
  );
